...
public class Student implements Parcelable {
    ...
    public String toString() {
        return _name + " " + _major + " " + _classStanding.getClassStanding();
    }
    ...
    private Student(Parcel in) {
        ...
        _id = in.readInt();
        _classStanding = (ClassStanding) in.readSerializable(); //other variable use their native
        // serializable, but ClassStanding doesn't have one; so, make it generic and then cast it
