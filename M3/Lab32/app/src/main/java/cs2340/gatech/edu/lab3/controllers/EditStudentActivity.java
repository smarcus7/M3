...
public class EditStudentActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        ArrayAdapter<String> majorAdapter = new ArrayAdapter(this,android.R.layout.simple_spinner_item, Student.legalMajors);
        majorAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        majorSpinner.setAdapter(majorAdapter);


        /*
        * Set up the adapter to display allowable class standings in the spinner
        */
        ArrayAdapter<String> classStandingAdapter = new ArrayAdapter(this,android.R.layout.simple_spinner_item, ClassStanding.values());
